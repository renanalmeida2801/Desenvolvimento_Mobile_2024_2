    ...
    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center){
        AnimatedVisibility(
            ...
            Column(
                ...
                Text("Criar conta", fontSize = 30.sp, style = MaterialTheme.typography.headlineLarge, color = Color(0xff49a439))
                ...
                TextButton(onClick = {navController.navigate("login")}) {
                    Text("Já tem uma conta? Faça login!" , color = Color(0xff49a439))
                }
            }
        }
    }
